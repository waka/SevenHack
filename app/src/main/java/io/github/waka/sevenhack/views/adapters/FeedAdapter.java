...
public class FeedAdapter extends BaseRecyclerAdapter<Podcast, FeedAdapter.ViewHolder>
        implements View.OnClickListener {

    public FeedAdapter(@NonNull Context context, OnItemClickListener<Podcast> onItemClickListener) {
